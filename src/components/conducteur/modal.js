    ...
    <div>
      ...
      <Modal style={{ marginTop: "140px" }} isOpen={modal} toggle={toggle} {...args}>
        ...
        <ModalBody>
          <Form>
            <FormGroup>
              <Label for="exampleEmail">Nom et Prénom</Label>
            ...
            <FormGroup tag="fieldset">
              ...
              <FormGroup check>
                <Input name="radio1" type="radio" /> <Label check>Dacia 185 TN 8585</Label>
              </FormGroup>
            </FormGroup>
            <FormGroup>
            ...
            <FormGroup tag="fieldset">
              ...
              <FormGroup check>
                <Input name="radio1" type="radio" /> <Label check>Sousse,Tunisie</Label>
              </FormGroup>
              <FormGroup check>
                <Input name="radio1" type="radio" /> <Label check>Gabes,Tunisie</Label>
              </FormGroup>
              <FormGroup check>
                <Input name="radio1" type="radio" /> <Label check>Nabeul,Tunisie</Label>
              </FormGroup>
            </FormGroup>
            {/* <FormGroup check>
